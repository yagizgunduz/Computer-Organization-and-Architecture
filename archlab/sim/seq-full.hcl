...
#  PC Update     PC<-valA              #
########################################
# In fetch stage our function ijmpq is added to "valid_instructions"
# And we add it to "need_regids" too because we need a register
# In decode stage I used rA as the srcA for the register question
# Finally, in Program Counter Update stage we update with the valA
